...
t.test(subset(Suspension,Manufacturing_Lot=="Lot1")$PSI,mu = 1500) #Lot1
t.test(subset(Suspension,Manufacturing_Lot=="Lot2")$PSI,mu = 1500) #Lot2
t.test(subset(Suspension,Manufacturing_Lot=="Lot3")$PSI,mu = 1500) #Lot3
